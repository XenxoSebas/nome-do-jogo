...
def get_random_empty_cell():
    while True:
        ...
        if tilemap[y][x] == 0 and (x, y) != (grid_x, grid_y) and (x, y) != (player2_x, player2_y):
            return x, y
...
while not gameExit:
    ...
    for cx, cy in collectibles:
        pygame.draw.circle(gameDisplay, yellow, (cx * cell_size + cell_size // 2, cy * cell_size + cell_size // 2),
                           cell_size // 4)
